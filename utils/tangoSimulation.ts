...
export const tangoMovements:Movement[]=[
 ...
 {id:'cruce',nameNl:'Cruce',nameEn:'Cross',initiator:'a',systemNl:'drielijnspositie → kruisen → verzamelen',systemEn:'three-track position → cross → collect',sequenceNl:['beide linkervoeten op één lijn','A tordeert rechtsvoor','A houdt in en lost deels op','B kruist links voor rechts','gewicht naar links','rechts verzamelt'],sequenceEn:['both left feet share one track','A twists forwards-right','A pauses and partly releases','B crosses left in front of right','weight moves left','right collects'],next:['forward-ocho','side-step','forward-step'],keyframes:[
  k(0,'available','De dansers staan in de drielijnspositie: hun linkervoeten liggen op dezelfde lengtelijn. B draagt rechts; haar linkervoet is vrij.','The dancers are in the three-track position: their left feet share the same longitudinal track. B is supported on the right; her left foot is free.',d(330,250,0,f(310,232,0,0),f(310,268,0,1)),d(470,250,180,f(490,232,180,0),f(490,268,180,1))),
  k(.16,'proposal','A geeft vanuit een lichte torsie naar rechts een voorwaartse impuls. De voeten blijven nog staan; B neemt de veranderde baan waar.','A gives a forward impulse from a slight twist to the right. The feet remain in place; B perceives the altered track.',d(344,246,10,f(310,232,4,0),f(310,268,4,1)),d(478,248,184,f(490,232,180,0),f(490,268,180,1))),
  k(.32,'proposal','A houdt de voorwaartse beweging in en lost de torsie gedeeltelijk op. Daarmee ontstaat voor B de uitnodiging om voorlangs te kruisen.','A checks the forward movement and partly releases the twist. This creates the invitation for B to cross in front.',d(350,244,5,f(310,232,3,0),f(310,268,3,1)),d(482,246,181,f(490,232,180,0),f(490,268,180,1))),
  k(.52,'projection','B beweegt links vanuit de gedeelde lijn voor de rechtervoet langs. Rechts blijft het standbeen; er is nog geen gewicht overgedragen.','B moves the left foot from the shared track in front of the right. The right remains the supporting foot; no weight has transferred yet.',d(366,242,3,f(310,232,2,0),f(395,268,2,.08)),d(490,244,180,f(470,238,180,0),f(490,260,180,1))),
  k(.68,'projection','B plaatst links voorbij en aan de rechterzijde van haar rechtervoet. De gekruiste positie is gevormd, maar rechts draagt nog volledig.','B places the left foot beyond and to the right of her right foot. The crossed position has formed, but the right still carries all the weight.',d(384,242,1,f(360,232,1,0),f(405,268,1,.08)),d(482,242,180,f(458,238,180,0),f(486,258,180,1))),
