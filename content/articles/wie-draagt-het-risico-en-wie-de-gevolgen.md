---
title: "Betalen: wie draagt het risico?"
description: Een verbetervoorstel voor online betalen, waarbin we eigen geld, reserveringen, krediet, levering en kosten overzichtelijker, eerlijker en veiliger maken.
date: 2026-09-17
updated: 2026-09-18
tags: [Economie, Financiën, Betalen, Consumentenbescherming]
...
featuredImageAlt: Een koper reserveert eigen geld veilig terwijl een pakket wordt bezorgd; pas na aanvaarde levering stroomt het geld door naar de winkel
featuredImageFocalPoint: center center
featuredImageMobileFocalPoint: center center
summary: "Achteraf betalen mengt soms twee verschillende behoeften: zekerheid over levering en krediet. Door eigen geld te reserveren, alleen een werkelijk tekort als krediet te behandelen en betaling aan de toestand van de bestelling te koppelen, kunnen verplichtingen en risico’s eerder zichtbaar worden."
keyPoints:
  ...
  - Regels horen de economische functie en risico's te volgen, niet de productnaam of gebruikte techniek.
...
plainLanguage:
  ...
  intro: >-
    Stel dat je online schoenen van €500 bestelt. Je wilt pas betalen wanneer je zeker weet dat ze zijn aangekomen. Dat is begrijpelijk. Maar achter de knop ‘achteraf betalen’ kunnen twee heel verschillende situaties zitten. Misschien heb je de €500 al. Misschien moet je het bedrag geheel of gedeeltelijk lenen. Dit artikel stelt voor om dat verschil zichtbaar te maken en betaling, levering en betwisting als één proces te behandelen.
  sections:
    - heading: Als het geld er al is, hoeft er geen lening te ontstaan
      paragraphs:
        - Heb je €2.000 op je rekening, dan kan de bank €500 tijdelijk apart zetten. Je ziet nog steeds hoeveel geld je bezit, maar ook dat je nog maar €1.500 vrij kunt uitgeven. De winkel weet dat het aankoopbedrag beschikbaar is. Het geld gaat pas naar de winkel nadat de levering volgens de afgesproken regels is aanvaard.
        - Dit is een reservering, geen lening. Wordt de bestelling geannuleerd of terecht betwist, dan komt het gereserveerde geld weer vrij. Heb je zelf maar €200, dan worden die €200 gereserveerd en is alleen de ontbrekende €300 krediet. Zo blijven eigen geld, gereserveerd geld en schuld drie verschillende zaken.
    - heading: De komende regels beschermen mensen beter tegen kredietrisico
      paragraphs:
    ...
    - heading: Een controle moet ook meteen de beschikbare ruimte veranderen
      paragraphs:
        ...
        - Daarom moet een goed systeem niet alleen controleren. Het moet de gebruikte ruimte ook direct reserveren. Na de eerste reservering van €400 ziet de tweede winkel dat nog maar €100 beschikbaar is. Dit vereist een gedeelde en actuele administratie. Het artikel noemt dat een transactioneel capaciteitsregister. Dat is een ontwerpvoorstel, geen bestaand Nederlands systeem.
    - heading: Een creditcard reserveert nu al kredietruimte
      paragraphs:
        - Bij een echte creditcard wordt een betaling meestal eerst goedgekeurd en van de beschikbare kaartlimiet afgehaald. Later wordt zij definitief geboekt en ontstaat een openstaand kaartsaldo. Bij annulering of fraude kan de reservering vervallen of kan een chargeback nodig zijn. Een prepaidkaart werkt anders, omdat daarop geld staat dat al van de gebruiker is.
        - Het voorstel uit dit artikel breidt dit bekende principe uit. Niet alleen de kaartuitgever, maar ook andere relevante kredietbeslissingen zouden rekening moeten houden met dezelfde actuele verplichting. De reservering op de kaart en die in het bredere register zijn dan twee weergaven van hetzelfde bedrag en mogen niet dubbel worden geteld.
    - heading: Levering, betwisting en betaling horen bij dezelfde bestelling
      paragraphs:
        - Een bestelling is niet klaar zodra het geld is gereserveerd. Het systeem moet ook weten of het product is geleverd, geaccepteerd, teruggestuurd of betwist. Pas daarna kan het geld definitief worden overgemaakt of weer worden vrijgegeven. Daarvoor zijn duidelijke bewijs- en bezwaarregels nodig. Een bezorgscan alleen bewijst bijvoorbeeld niet altijd dat het juiste product bij de juiste persoon is aangekomen.
        - >-
          In het interactieve model kun je daarom per bestelling een bestel-, leverings- en betaaldatum kiezen. Je kunt drie situaties vergelijken: de huidige situatie, een vereenvoudigde weergave van het wetsvoorstel en het reserveringsmodel uit dit artikel. De grafiek laat zien wanneer geld of krediet nog vaststaat. De uitkomsten zijn voorbeelden en geen persoonlijk financieel advies.
  takeaway: Maak afzonderlijk zichtbaar welk geld al bestaat, welk bedrag wordt gereserveerd, welke schuld werkelijk ontstaat en wanneer levering tot betaling leidt. Laat regels daarbij de werkelijke functie en risico's volgen, niet de productnaam.
modelComponent: payment-system
modelLimitations:
  - De drempels zijn didactische aannames, geen empirisch gekalibreerde kredietscore.
...
Een van de nieuwere manieren om met online betalingsproblemen om te gaan is achteraf betalen. Daarmee loopt een koper minder leveringsrisico: de betaling volgt pas nadat het product is ontvangen. Maar achteraf betalen heeft ook een bijeffect. Het is een vorm van krediet, met vaak niet zozeer rente maar wel forse kosten wanneer een termijn wordt gemist. In 2024 leidde ongeveer één op de 29 BNPL-transacties tot aanmaningskosten en ongeveer één op de 88 tot overdracht aan een incassobureau. Bij zo’n incassotraject bedragen de wettelijke incassokosten minimaal €40 — veel bij een betaalvorm waarbij juist kleine bedragen geregeld in de problemen komen.[9][10]

De problemen beperken zich niet tot aanmaningskosten. Onder BNPL-gebruikers jonger dan 35 jaar stond in 2024 één op de zes meer dan negentig dagen per jaar rood. Deze groep miste of storneerde gemiddeld ongeveer tien incasso’s per jaar, en dat aantal liep op naarmate mensen vaker achteraf betaalden. De AFM benadrukt dat deze cijfers niet bewijzen dat BNPL de financiële problemen veroorzaakt: mensen die al financieel kwetsbaar zijn, kunnen ook vaker achteraf betalen. Maar juist die samenhang maakt kredietverlening zonder actueel zicht op iemands totale verplichtingen riskant.[1]

Dit artikel onderzoekt daarom eerst het functionele probleem: achter één betaalknop gaan beschikbaar geld, krediet, levering, toestemming, fraude en kosten door de tijd schuil. Vervolgens werkt het een concreet reserveringsmodel uit en legt dat naast bestaande betaalvormen en de komende regels voor consumentenkrediet. De bredere vraag wie voordeel krijgt en wie latere maatschappelijke schade draagt, is uitgewerkt in het gekoppelde artikel over gevolgen en aanspreekbaarheid.
...
Zoals iemand nu soms kan instellen hoeveel die rood mag staan of per dag online mag betalen, zou ook een overkoepelende persoonlijke kredietgrens kunnen worden ingesteld. Wettelijke grenzen of standaarden kunnen daar bovenop komen, bijvoorbeeld afhankelijk van leeftijd en bestaande kredietregels.
...
De herziene Europese richtlijn consumentenkrediet brengt onder meer achteraf betalen nadrukkelijker onder kredietbescherming.[2] Op 17 september 2026 lag de Nederlandse implementatie nog als wetsvoorstel bij de Tweede Kamer (geplande behandeling 28 sept). De precieze uitwerking kan dus nog veranderen.[4]

Het voorstel pakt belangrijke problemen aan. Aanbieders komen in beginsel onder financieel toezicht, moeten kredietwaardigheid beoordelen, duidelijker informeren en instemming vastleggen. Ook bevat het regels rond beloningsprikkels, betalingsproblemen, geschillen en effectieve leeftijdsverificatie.[5] Dat laatste is relevant omdat de AFM over 2023 bijna 600.000 mogelijk ongeoorloofde BNPL-transacties via rekeningen van minderjarigen vond.[6]
...
1. Autoriteit Financiële Markten. *Buy Now, Pay Later Marktupdate 2025*. 2025. [Bron bekijken](https://www.afm.nl/~/profmedia/files/rapporten/2025/rapport-marktupdate--bnpl-2025-ned.pdf)
2. Europese Unie. *Richtlijn (EU) 2023/2225 inzake kredietovereenkomsten voor consumenten*. 2023. [Bron bekijken](https://eur-lex.europa.eu/legal-content/NL/TXT/?uri=CELEX:32023L2225)
3. Stichting BKR. *Kredietregistratie bij Stichting BKR*. [Bron bekijken](https://www.bkr.nl/media/ssqbz200/kredietregistratie-bij-stichting-bkr.pdf)
4. Tweede Kamer der Staten-Generaal. *Implementatiewet herziene richtlijn consumentenkrediet (36 924)*. Stand geraadpleegd op 17 september 2026. [Bron bekijken](https://www.tweedekamer.nl/kamerstukken/wetsvoorstellen/detail?cfg=wetsvoorsteldetails&qry=wetsvoorstel%3A36924)
5. Ministerie van Financiën. *Memorie van toelichting bij de Implementatiewet herziene richtlijn consumentenkrediet*. 2026. [Bron bekijken](https://zoek.officielebekendmakingen.nl/kst-36924-3.html)
6. Autoriteit Financiële Markten. *Aanpak nodig om gebruik van buy now pay later door minderjarigen te stoppen*. 2024. [Bron bekijken](https://www.afm.nl/nl-nl/sector/actueel/2024/april/bnpl-marktbeeld-experiment)
7. Rijksoverheid. *Ben ik aansprakelijk voor de schulden van mijn minderjarige kinderen?* [Bron bekijken](https://www.rijksoverheid.nl/vraag-en-antwoord/schulden/schulden-van-kinderen)
8. Rijksoverheid. *Nieuwe regels voor Buy Now Pay Later*. 2025. [Bron bekijken](https://www.rijksoverheid.nl/actueel/nieuws/2025/10/31/nieuwe-regels-voor-buy-now-pay-later)
9. Autoriteit Financiële Markten. *Buy Now, Pay Later: extra bescherming consumenten nodig*. 2025. [Bron bekijken](https://www.afm.nl/nl-nl/sector/actueel/2025/juli/pb-marktupdate-BNPL-2025)
10. Rijksoverheid. *Hoeveel betaal ik voor incassokosten?* [Bron bekijken](https://www.rijksoverheid.nl/vraag-en-antwoord/schulden/hoogte-incassokosten)
