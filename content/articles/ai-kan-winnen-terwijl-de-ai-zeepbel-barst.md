...
summary: De vraag of AI een zeepbel is, voegt verschillende onzekerheden ten onrechte samen. AI kan veel waarde creëren terwijl huidige infrastructuurinvesteringen toch te groot blijken, bedrijfswinsten groeien terwijl de consumptievraag verzwakt, en AI dieper in de economie doordringt terwijl per eenheid economische waarde steeds minder terugkerende rekenkracht nodig is.
keyPoints:
...
plainLanguage:
  ...
  sections:
    - heading: Waarde en rendement zijn niet hetzelfde
      paragraphs:
        - AI kan bedrijven helpen meer te produceren of goedkoper te werken. Toch moet de opbrengst groot en snel genoeg zijn om datacenters, chips en energievoorziening terug te verdienen.
    - heading: Wie ontvangt de besparing?
      paragraphs:
        - Als bedrijven minder loon betalen, houden zij meer over. Huishoudens verliezen dan mogelijk inkomen. Nieuwe banen, lagere prijzen en herverdeling kunnen dat opvangen, maar dit gebeurt niet automatisch.
    - heading: Meer AI betekent niet vanzelf evenredig meer computers
      paragraphs:
        - Sommige taken kunnen later door een kleiner model of gewone software worden uitgevoerd. Efficiëntie maakt AI tegelijk goedkoper en kan daardoor juist veel nieuw gebruik uitlokken. Welke kracht het snelst groeit, blijft onzeker.
  takeaway: De belangrijkste vraag is niet alleen hoeveel AI we gaan gebruiken, maar hoeveel waarde AI creëert, wie die waarde ontvangt en hoeveel terugkerende rekenkracht daarvoor nodig blijft.
modelComponent: ai-investment-system
modelLimitations:
  - De modellen onderzoeken mechanismen en gevoeligheid; zij voorspellen geen marktwaarde, werkgelegenheid of datacentervraag.
  - Kosten, consumptiequotes en relatieve rekeneenheden zijn zichtbare scenarioaannames.
  - Prijzen, belastingen, monetair beleid, internationale handel en nieuwe bedrijfstakken zijn slechts gedeeltelijk of niet gemodelleerd.
draft: false
---

De discussie over de huidige investeringsgolf in kunstmatige intelligentie wordt vaak teruggebracht tot één vraag: is AI een zeepbel?

Die vraag is te grof. Zij behandelt minstens vier verschillende verwachtingen alsof ze hetzelfde zijn:

1. AI wordt economisch belangrijk.
2. AI creëert snel genoeg voldoende waarde om de huidige infrastructuurinvesteringen te rechtvaardigen.
3. Die waarde blijft ongeveer de soort en hoeveelheid rekeninfrastructuur vragen die nu wordt gebouwd.
4. De economische opbrengst wordt zo verdeeld dat bedrijven hun groeiende productie ook kunnen blijven verkopen.

Deze verwachtingen hangen samen, maar geen ervan volgt automatisch uit de vorige. AI kan een zeer belangrijke technologie worden terwijl bepaalde datacenters te vroeg, te duur of voor de verkeerde rekentaak zijn gebouwd. Het kan bedrijven uitzonderlijk veel opleveren en tegelijk inkomen verschuiven op een manier die de consumptievraag verzwakt. En AI kan steeds meer economische beslissingen beïnvloeden terwijl iedere beslissing juist veel minder rekenkracht gaat kosten.
...
Dat is geen voorspelling. Exploitatiekosten, belastingen, verschillende activaklassen en investeringsmomenten ontbreken. Het is een controle op schaal: hoeveel economische opbrengst moet ongeveer tegenover een bepaalde kapitaalbasis staan?

::ModelDisclosure{title="Infrastructuur en vereist rendement" description="Verander kapitaal, levensduur, rendement en marge en zie hoe gevoelig de benodigde omzet is."}
  ::AiInvestmentExplorer{view="roi" locale="nl"}
  ::
::
...
Maar loonkosten aan de ene kant zijn arbeidsinkomen aan de andere kant. Wanneer een deel van het looninkomen verandert in kapitaalinkomen, verandert mogelijk ook wat van dat inkomen wordt besteed. Onderzoek naar consumptiegedrag vindt doorgaans dat de marginale consumptiequote afneemt bij grotere inkomens en vermogens, al varieert de precieze omvang sterk met meetmethode en omstandigheden.[3]

Een illustratief voorbeeld laat het mechanisme zien. Stel dat huishoudens negentig procent van één biljoen euro arbeidsinkomen consumeren. Wanneer tweehonderd miljard euro aan arbeidsinkomen verdwijnt, valt daarvan 180 miljard aan consumptie weg. Als dezelfde tweehonderd miljard volledig als kapitaalinkomen terugkeert en de ontvangers daarvan veertig procent consumeren, komt tachtig miljard terug. Het verschil is honderd miljard euro.

De werkelijkheid bevat sterke tegenkrachten. Werknemers kunnen ander werk vinden, complementaire vaardigheden kunnen meer waard worden, prijzen kunnen dalen, winsten kunnen worden geïnvesteerd, overheden kunnen inkomen herverdelen en nieuwe producten kunnen nieuwe vraag creëren. Recente IMF-analyse van daadwerkelijk AI-gebruik vindt bovendien grote potentiële tijdsbesparingen, maar benadrukt dat de uiteindelijke verdeling tussen werknemers en bedrijven nog openligt.[4]

::ModelDisclosure{title="Van arbeidsinkomen naar kapitaalinkomen" description="Bekijk hoe dezelfde productiviteitswinst anders doorwerkt bij andere herplaatsing, lonen en consumptiequotes."}
  ::AiInvestmentExplorer{view="distribution" locale="nl"}
  ::
::
...
Een tweede patroon gebruikt een duur algemeen model om een goedkoper gespecialiseerd model voor herhaald werk te maken. Onderzoekers van Google rapporteerden in 2026 meer dan honderdvoudige reducties in kosten en latentie voor geschikte semantische SQL-filters door lichte proxy-modellen op embeddings te trainen. Zij maten dit op specifieke queryoperators en datasets; het resultaat geldt niet voor iedere redeneertaak.[6]

Een derde patroon gaat nog verder. AI kan tijdens een verbouwing van software intensief worden gebruikt om bestaand gedrag te analyseren, uitzonderingen te vinden, logica opnieuw te ontwerpen, tests te genereren en oud en nieuw gedrag te vergelijken. Het uiteindelijke productiesysteem kan vervolgens gewone deterministische software zijn:

> invoer → expliciete code → beslissing

De productiviteitswinst blijft bestaan, maar terugkerende LLM-inferentie kan bijna verdwijnen.
...
Softwarebouw kent dit principe al. Een compiler doet vooraf kostbare analyse en produceert iets dat daarna miljarden keren goedkoop kan draaien. AI maakt een vergelijkbare architectuur mogelijk:

> dure analyse → herbruikbare representatie → goedkope uitvoering
...
Daar komt een recursieve lus bij. AI wordt gebruikt voor modelarchitectuur, kwantisatie, distillatie, kernels, compilers, chipontwerp, synthetische data en softwareanalyse. Onderzoek naar kortere redeneerketens laat bovendien zien dat meer gegenereerde redeneerstappen niet altijd tot een betere uitkomst leiden.[7] Google beschrijft hoe reinforcement learning via AlphaChip werd ingezet voor chip-floorplanning.[8] Algoritmische verbetering is daardoor niet volledig extern aan AI:
...
Onderbenutting kan tijdelijk zijn. Capaciteit kan later alsnog worden gevuld, voor andere taken worden gebruikt of onderdeel zijn van strategische redundantie. Andersom kan een tekort prijsstijgingen en vertraging veroorzaken. Het model geeft daarom geen oordeel, maar maakt zichtbaar welke combinatie van activiteit, efficiëntie, architectuur en bouwtempo een kloof veroorzaakt.

## Conclusie

Het economische belang van AI, de winstgevendheid van de huidige AI-infrastructuur, de verdeling van AI-inkomen en de toekomstige rekenintensiteit van AI zijn verschillende vragen.
...
1. McKinsey & Company. *The cost of compute: A $7 trillion race to scale data centers*. 2025. [Bron bekijken](https://www.mckinsey.com/industries/technology-media-and-telecommunications/our-insights/the-cost-of-compute-a-7-trillion-dollar-race-to-scale-data-centers)
2. Marcello Estevão. *AI Can Lift Global Growth*. IMF Finance & Development, 2026. [Bron bekijken](https://www.imf.org/-/media/files/publications/fandd/article/2026/03/estevo.pdf)
3. Fisher, Johnson, Smeeding en Thompson. *Estimating the Marginal Propensity to Consume Using the Distributions of Income, Consumption and Wealth*. Federal Reserve Bank of Boston, 2019. [Bron bekijken](https://www.bostonfed.org/-/media/Documents/Workingpapers/PDF/2019/wp1904.pdf)
4. Fan en Nguyen. *Aggregate Gains from AI and Their Distribution: Global Evidence from Usage Data*. IMF Working Paper 26/147, 2026. [Bron bekijken](https://www.imf.org/-/media/files/publications/wp/2026/english/wpiea2026147.pdf)
5. Jev AI. *Decisions at machine speed*. Leveranciersinformatie, geraadpleegd 2026. [Bron bekijken](https://jevai.net/)
6. Chung et al. *Achieving 100x Cost & Latency Reduction: Performance Analysis of AI Query Approximation using Lightweight Proxy Models*. Proceedings of the ACM on Management of Data, 2026. [Bron bekijken](https://research.google/pubs/achieving-100x-cost-latency-reduction-performance-analysis-of-ai-query-approximation-using-lightweight-proxy-models/)
7. Ding et al. *Don't Overthink it. Preferring Shorter Thinking Chains for Improved LLM Reasoning*. arXiv preprint, 2025. [Bron bekijken](https://arxiv.org/abs/2505.17813)
8. Google DeepMind. *How AlphaChip transformed computer chip design*. 2024. [Bron bekijken](https://deepmind.google/blog/how-alphachip-transformed-computer-chip-design/)
9. Office of Foreign Assets Control. *Issuance of Executive Order Imposing Sanctions on the International Criminal Court; ICC-related Designation*. 2025. [Bron bekijken](https://ofac.treasury.gov/recent-actions/20250213)
10. The White House. *Imposing Sanctions on the International Criminal Court*. Executive Order, 2025. [Bron bekijken](https://www.whitehouse.gov/presidential-actions/2025/02/imposing-sanctions-on-the-international-criminal-court/)
