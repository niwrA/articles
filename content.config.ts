...
const articleSchema = z.object({
  ...
  modelComponent: z.enum(['housing-policy', 'proper-time', 'consciousness', 'self-organization', 'tango-movement', 'coffee-cups', 'car-needs', 'sport-dividend', 'pathogen-response', 'risk-responsibility', 'payment-system', 'risk-accountability', 'migration-labour-system', 'ai-investment-system', 'knowledge-layer']).optional(),
