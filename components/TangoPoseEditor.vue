...
onMounted(()=>{const saved=localStorage.getItem('tango-editor-load-mode') as LoadMode|null;if(saved&&['manual','suggest','auto'].includes(saved))loadMode.value=saved})
